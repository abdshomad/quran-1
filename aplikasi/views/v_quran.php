...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=path_asset('extjs/examples/ux/css/TabScrollerMenu.css')?>" />
	<link rel="stylesheet" type="text/css" href="<?=path_asset('extjs/examples/ux/css/CheckHeader.css')?>" />
	<link rel="stylesheet" type="text/css" href="<?=path_asset('extjs/examples/tabs/tabs-adv.css')?>" />
	<link rel="stylesheet" type="text/css" href="<?=path_asset('extjs/examples/tabs/tabs.css')?>" />
	<link rel="stylesheet" type="text/css" href="<?=path_asset('extjs/examples/ux/grid/css/GridFilters.css')?>" />
	<link rel="stylesheet" type="text/css" href="<?=path_asset('extjs/examples/ux/grid/css/RangeMenu.css')?>" />
    <style type="text/css">
