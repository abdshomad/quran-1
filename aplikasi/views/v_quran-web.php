...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://novaherdi.16mb.com/extjs/resources/css/ext-all.css" />
	<link rel="stylesheet" type="text/css" href="http://novaherdi.16mb.com/extjs/examples/ux/css/TabScrollerMenu.css" />
	<link rel="stylesheet" type="text/css" href="http://novaherdi.16mb.com/extjs/examples/ux/css/CheckHeader.css" />
	<link rel="stylesheet" type="text/css" href="http://novaherdi.16mb.com/extjs/examples/tabs/tabs-adv.css" />
	<link rel="stylesheet" type="text/css" href="http://novaherdi.16mb.com/extjs/examples/tabs/tabs.css" />
    <style type="text/css">
...
<body>
	...
	<script type="text/javascript" src="http://novaherdi.16mb.com/extjs/ext-all.js"></script>
	...
	<div style="display:none;">
        ...
        <div id="tentang-div">
            ...
            <div style="margin-left:50px;">
				...
				<br>
				Assalamualaikum Warrahmatullahi Wabarokatuh,<br><br>
				Puji dan syukur senantiasa kita panjatkan ke hadirat Alloh swt. atas segala nikmat dan karunia-Nya. Shalawat dan salam semoga tercurah kepada Rasulullah saw, keluarga, sahabat, dan para pengikutnya. Amin.<br>
				<br>Web developer berusaha untuk dapat memberikan sumbangsih pengetahuan yang didapat dari berbagai pengalaman dalam pembangunan aplikasi dan demi kelancaran para sabahat pengguna Internet untuk bisa mencari referensi dalam kitab yang kita imani bersama yaitu Al-Qur'anul Karim yang penuh dengan hikmah, maka terciptalah aplikasi berbasis web ini.
				<br>Semoga hidayah dan rahmah Allah swt selalu tercurah kepada kita semua.<br>
				<br>Pakailah dengan Bijak wahai sahabatku.. :)<br>
				<br>Wassalamualaikum wr wb,<br>
				Tim penyusun.<br>
